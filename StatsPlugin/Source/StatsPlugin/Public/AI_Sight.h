...
public:	
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "SightAction")
		void FindNearestTarget(TArray<AActor*> Actors, TArray<FIgnoreRule> IgnoreRule, AActor*& Target);

	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "SightAction")
		void FindFarthestTarget(TArray<AActor*> Actors, TArray<FIgnoreRule> IgnoreRule, AActor*& Target);

	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "SightAction")
		void FindByRatingTarget(TArray<AActor*> Actors, TArray<FStatsRating> RatingRules, TArray<FIgnoreRule> IgnoreRule, bool MaxRating, AActor*& Target);
