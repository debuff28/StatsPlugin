...
void UAI_Sight::Update()
{
	...
	if ((FDateTime::Now().operator-(TargetEnemySetupTime)).GetTotalMilliseconds() > UpdatePeriod * 3)
	{
		...
		case ETargetSelectingRule::TSR_DistanceNearest:
			FindNearestTarget(Enemys, EnemyIgnoreRule, TargetEnemy);
			TargetEnemySetupTime = FDateTime::Now();
			break;
		case ETargetSelectingRule::TSR_DistanceFarthest:
			FindFarthestTarget(Enemys, EnemyIgnoreRule, TargetEnemy);
			TargetEnemySetupTime = FDateTime::Now();
			break;
		case ETargetSelectingRule::TSR_Rating:
			FindByRatingTarget(Enemys, EnemyTargetRating, EnemyIgnoreRule, EnemyTargetSelectMaxRating, TargetEnemy);
			TargetEnemySetupTime = FDateTime::Now();
			break;
		default:
			break;
	...
	if ((FDateTime::Now().operator-(TargetFriendSetupTime)).GetTotalMilliseconds() > UpdatePeriod * 3)
	{
		...
		{
		case ETargetSelectingRule::TSR_DistanceNearest:
			FindNearestTarget(Friends, FriendIgnoreRule, TargetFriend);
			TargetFriendSetupTime = FDateTime::Now();
			break;
		case ETargetSelectingRule::TSR_DistanceFarthest:
			FindFarthestTarget(Friends, FriendIgnoreRule, TargetFriend);
			TargetFriendSetupTime = FDateTime::Now();
			break;
		case ETargetSelectingRule::TSR_Rating:
			FindByRatingTarget(Friends, FriendTargetRating, FriendIgnoreRule, FriendTargetSelectMaxRating, TargetFriend);
			TargetFriendSetupTime = FDateTime::Now();
			break;
		default:
			break;
...
void UAI_Sight::FindNearestTarget(TArray<AActor*> Actors, TArray<FIgnoreRule> IgnoreRule, AActor*& Target)
{
	Target = NULL;
...
void UAI_Sight::FindFarthestTarget(TArray<AActor*> Actors, TArray<FIgnoreRule> IgnoreRule,  AActor*& Target)
{
	Target = NULL;
...
void UAI_Sight::FindByRatingTarget(TArray<AActor*> Actors, TArray<FStatsRating> RatingRules, TArray<FIgnoreRule> IgnoreRule, bool MaxRating, AActor*& Target)
{
	Target = NULL;
	float Rating;
