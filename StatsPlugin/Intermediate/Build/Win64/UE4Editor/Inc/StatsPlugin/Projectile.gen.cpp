...
#include "StatsPlugin/Public/Projectile.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	STATSPLUGIN_API UClass* Z_Construct_UClass_AProjectile_NoRegister();
	STATSPLUGIN_API UClass* Z_Construct_UClass_AProjectile();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectile_Statics::NewProp_TeamID_MetaData[] = {
		{ "Category", "Info" },
		{ "ModuleRelativePath", "Public/Projectile.h" },
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_AProjectile_Statics::NewProp_TeamID = { UE4CodeGen_Private::EPropertyClass::Name, "TeamID", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000024, 1, nullptr, STRUCT_OFFSET(AProjectile, TeamID), METADATA_PARAMS(Z_Construct_UClass_AProjectile_Statics::NewProp_TeamID_MetaData, ARRAY_COUNT(Z_Construct_UClass_AProjectile_Statics::NewProp_TeamID_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AProjectile_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProjectile_Statics::NewProp_TeamID,
	};
	...
	IMPLEMENT_CLASS(AProjectile, 2658456523);
	static FCompiledInDefer Z_CompiledInDefer_UClass_AProjectile(Z_Construct_UClass_AProjectile, &AProjectile::StaticClass, TEXT("/Script/StatsPlugin"), TEXT("AProjectile"), false, nullptr, nullptr, nullptr);
